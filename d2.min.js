    ...
    checkFeed: function () {
        ...
        jQuery.ajax({
            ...
            success: function (b) {
                ...
                var jsonComments = jsonResult["commentsUnread"];
                var jsonFeed = jsonResult["feedUnread"];
                var jsonMessages = jsonResult["messagesUnread"];
                ...
                if (jsonMessages.length > 0)
                {
                    ...
                    if (pvtMessagesCount > 0)
                    {
                        ...
                        d2.onClickUrl = d2.rootUrl + d2.messagesUrl;
                    }
                }
