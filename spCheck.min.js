var spCheck = {
    ...
    checkFeed: function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: spCheck.rootUrl + spCheck.messagerUrl,
            ...
            success: function (b) {
                ...
                if (feedItems.length > 1)
                {
                    ...
                    spCheck.onClickUrl = spCheck.rootUrl + spCheck.feedUrl;
                }
                ...
                if (talkItems.length > 1)
                {
                    ...
                    spCheck.onClickUrl = spCheck.rootUrl + spCheck.talksUrl;
                }
    ...
    startCheck: function () {
        ...
        jQuery.ajax({
            ...
            success: function (b) {
                    ...
                    spCheck.checkFeed();
                    setInterval(spCheck.checkFeed, localStorage.requestInterval*1000);
                },
                error: function () {
                    chrome.browserAction.setBadgeText({ "text": "err" });
                }
    ...
    onClickedHandler: function () {
        ...
        chrome.windows.getAll({
            ...
            spCheck.updateAfterLoadTimeout = setTimeout(spCheck.updateAfterLoad, localStorage.updateAfterOpen*1000);            
        })
    }
};
